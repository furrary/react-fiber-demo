...
var _furrary$react_fiber_demo$ReactFiber$UnHover = {ctor: 'UnHover'};
var _furrary$react_fiber_demo$ReactFiber$Hover = function (a) {
	return {ctor: 'Hover', _0: a};
};
var _furrary$react_fiber_demo$ReactFiber$dot = F3(
...
var _furrary$react_fiber_demo$ReactFiber$sierpinskiTriangle = F5(
	function (hoveredNode, x, y, size, text) {
		if (_elm_lang$core$Native_Utils.cmp(size, _furrary$react_fiber_demo$ReactFiber$targetSize) < 1) {
			...
			return A2(
				_elm_lang$core$Basics_ops['++'],
				A5(_furrary$react_fiber_demo$ReactFiber$sierpinskiTriangle, hoveredNode, x, y - (newSize / 2), newSize, text),
				A2(
					_elm_lang$core$Basics_ops['++'],
...
var _furrary$react_fiber_demo$ReactFiber$update = F2(
	function (msg, model) {
		update:
		while (true) {
			var _p4 = msg;
...
var _furrary$react_fiber_demo$ReactFiber$subscriptions = function (model) {
	return _elm_lang$animation_frame$AnimationFrame$times(_furrary$react_fiber_demo$ReactFiber$SetCurrentTime);
};
...
var _furrary$react_fiber_demo$ReactFiber$init = {
	...
	_1: A2(_elm_lang$core$Task$perform, _furrary$react_fiber_demo$ReactFiber$SetStartTime, _elm_lang$core$Time$now)
};
var _furrary$react_fiber_demo$ReactFiber$main = _elm_lang$html$Html$program(
	{init: _furrary$react_fiber_demo$ReactFiber$init, view: _furrary$react_fiber_demo$ReactFiber$view, update: _furrary$react_fiber_demo$ReactFiber$update, subscriptions: _furrary$react_fiber_demo$ReactFiber$subscriptions})();

var Elm = {};
Elm['ReactFiber'] = Elm['ReactFiber'] || {};
if (typeof _furrary$react_fiber_demo$ReactFiber$main !== 'undefined') {
    _furrary$react_fiber_demo$ReactFiber$main(Elm['ReactFiber'], 'ReactFiber', undefined);
}
